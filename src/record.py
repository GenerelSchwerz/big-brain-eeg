...
def main():
    ...
    your_app_client_id = '0DyMfKwKuYAG72VKATaJUI51sEHlyGqpsTk19jPP'
    your_app_client_secret = 'Nv8JIEu7ew4zsdSbj1xha2vePzAr71JfYNi55oQDvnIOit4wSwctBIAha3XzLs4EbWR9R0ruo1gqUcUJ72UfKFnetgykJfkIfdW3OqqhZ4QcvUvIBmuZOiMBfJrGxk1F'
    ...
    r.record_title = 'bruh-test-1' # required param and can not be empty
    r.record_description = 'april-22nd' # optional param

    # input params for export_record. Please see on_warn_cortex_stop_all_sub()
    r.record_export_folder = '/Users/vidurmodgil/Desktop/ProgrammingProjects/big-brain-eeg/shit' # your place to export, you should have x permission, example on desktop
    r.record_export_data_types = ['MOTION']
